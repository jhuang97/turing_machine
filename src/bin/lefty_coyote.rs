...
impl fmt::Display for BlockSimulator {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match self.state {
            ...
            HigherState::RightBack => write!(f, "{}", "b>".red().bold())?,
        }
